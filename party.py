...
def is_mel(name, email):
    ...
    >>> is_mel('Mel Melit', 'cel@ubermelon.com')
    False

    >>> is_mel('Mel Melitpolski', 'cel@ubermelon.com')
    True

    >>> is_mel('Cal Melitpolski', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    Should return same type of food for most and least if there is only
    one type in the dictionary
    >>> one_type = [
    ...     {'type': 'dessert'},
    ... ]

    >>> most_and_least_common_type(one_type)
    ('dessert', 'dessert')

    Should return one value if there is a tie 
    >>> tie = [
    ... {'type': 'appetizer'},
    ... {'type': 'appetizer'},
    ... {'type': 'dessert'},
    ...
    >>> most_and_least_common_type(tie)
    ('dessert', 'drink')


    Should return no value (None) if no one is bringing treats or drinks
    >>> no_treat = [
    ... ]

    >>> most_and_least_common_type(no_treat)
    (None, None)
